...
function generateMessages (
  ...
  const messages: IOnboardingMessage[] = [
    ...
    },
    {
      ...
      text: `${SvgIcons.CAMERA} <b>Screenshot</b>: You can download a .png of the change-matrix.<br/>
      ...
      ${SvgIcons.LASSO_SELECTION} <b>Lasso select</b>: Select by drawing a lasso loop in the chart.</br>
      ...
      ${SvgIcons.AUTO_SCALE} <b>Autoscale</b>: Changes the layout to show the complete chart.<br/>
