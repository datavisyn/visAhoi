...
function generateMessages (
  ...
  const messages: IOnboardingMessage[] = [
    ...
    },
    {
      ...
      text: `${SvgIcons.CAMERA} <b>Screenshot</b>: You can download a .png of the scatterplot.<br/>${zoomIcon} <b>Zooming</b>: With the left click you can zoom in the scatterplot to get a more detailed view on the data.</br>${panIcon} <b>Panning</b>: You can move the view left and right while dragging the mouse.</br>${boxSelectIcon} <b>Selection</b>: Drag the mouse over the dots in the scatterplot to select a certain subset of the data.</br>${lassoSelectIcon} <b>Lasso select</b>: Select points by drawing a lasso loop around the points in the graph.</br>${zoomInIcon} <b>Zoom in</b>: With this you can zoom in the data points of the graph.</br>${zoomOutIcon} <b>Zoom out:</b> With this you can zoom out the data points in the graph.<br/>${autoScaleIcon} <b>Autoscale</b>: Looks at all the data points in the plot and changes the layout to show all of them.<br/>${resetIcon} <b>Reset</b>: It takes the plot to the inital layout settings.</br>`,      
      title: "Chart interactions",
      onboardingStage: interacting,
      marker: {
        id: uuidv4()
