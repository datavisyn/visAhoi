...
export class VisahoiState {
  ...
  constructor() {
    ...
    this.navigationAlignment =
      initializeStoreValue<NavigationAlignment>("horizontal");
    this.onboardingStages = initializeStoreValue<IOnboardingStage[]>([]);
    this.activeOnboardingStage = initializeStoreValue<IOnboardingStage | null>(
      null
    );
    ...
    this.contextId = initializeStoreValue<string>("");
  }
}
