...
function generateOnboardingSpec(chart) {
...
function barChartFactory(chart) {
...
function changeMatrixFactory(chart) {
    const onbordingSpec = generateOnboardingSpec$1(chart);
    return generateOnboardingMessages$3(EChartType.CHANGE_MATRIX, onbordingSpec);
}

function generateOnboardingSpec$2(chart) {
    // from https://github.com/plotly/plotly.js/blob/bff79dc5e76739f674ac3d4c41b63b0fbd6f2ebc/test/jasmine/tests/bar_test.js
...
function horizonGraphFactory(chart) {
    const onbordingSpec = generateOnboardingSpec$2(chart);
    return generateOnboardingMessages$3(EChartType.HORIZON_GRAPH, onbordingSpec);
}

function onboarding(chartType, chart) {
